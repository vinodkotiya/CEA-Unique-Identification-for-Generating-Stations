<%@ Page Language="VB" AutoEventWireup="false" CodeFile="genhome.aspx.vb" Inherits="genhome" EnableEventValidation="false" %>
...
<body>
    ...
    <%--  <li><a href="#"><span>Two</span></a></li>
      ...
      <li><a href="#"><span>Four</span></a></li>--%>
                                          ...
                                          <div id="form-area">
                                              ...
                                              <div id="form-body" style="height:1000px; overflow:auto;">
                                         <asp:Panel ID="pnlForm" runat="server" Visible="true" >
                                              <asp:DropDownList ID="ddlProject" runat="server" AutoPostBack="true" class="" style="overflow: auto !important;" DataValueField="project_code" DataTextField="projectname"    EnableViewState="true" >
          </asp:DropDownList> 
 ...
 <asp:Button ID="btnCompleteProj" runat="server" Visible="false" Text="Complete Project Details" style="background-image: -moz-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);   background-image: -webkit-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);    background-image: -ms-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);" CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10"  />  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  CssClass="gvRow"   AlternatingRowStyle-CssClass="gvAltRow"  AutoGenerateColumns="false">  <Columns>    <asp:TemplateField>
      <HeaderTemplate>      
          ...
          <th>Capacity</th>
                   <th>Status</th>
                     <th>Print Registration Certificate</th>
            <th>View Details</th>
                              <th>Add Details</th>
        </tr>
      </HeaderTemplate> 
      <ItemTemplate>
          ...
          <td><asp:LinkButton ID="btnPrint" runat="server" Text='<%# ceaCommon.hideRegNo(Eval("regnumber"), Eval("approvestatus"))%>' CommandArgument='<%# Eval("unit")%>' CommandName="Print" /></td>
           <td><asp:LinkButton ID="Button1" runat="server" Text="View" CommandArgument='<%# Eval("unit")%>' CommandName="View" /></td>
              <td><asp:Button ID="btnMyKPAEdit" runat="server" Text="Additional Details" Visible='<%#IIf(projAction(Eval("project_code"), Eval("unit")), True, False)%>' CommandArgument='<%# Eval("unit")%>' /></td>
      </ItemTemplate>
    </asp:TemplateField>
