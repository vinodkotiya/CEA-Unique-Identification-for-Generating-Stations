<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addunit.aspx.vb" Inherits="addunit" EnableEventValidation="false" %>
      ...
      <li><a href="#"><span>Four</span></a></li>--%>
                                          ...
                                          <div id="form-area">
                                           ...
                                           <asp:Panel ID="pnlSignUp" runat="server" Visible="True" >
                                                <span id="lb11" class="form-label">Project Name*</span>
                                                <asp:Label ID="lbProjectName" runat="server" Text=""></asp:Label> <br />
                                              
                                               <span id="lb12" class="form-label">Project Type*</span>
                                               <asp:Label ID="lbProjectType" runat="server" Text=""></asp:Label> <br />
                                                 <span id="lb13" class="form-label">Project Code*</span>
                                              <asp:Label ID="lbProjectCode" runat="server" Text=""></asp:Label> <br />
                                                    <span id="lb114" class="form-label">Fuel*</span>
                                                <asp:DropDownList ID="ddlFuel" runat="server" AutoPostBack="true" CssClass="" DataValueField="fuel" DataTextField="fuel"    EnableViewState="true" > </asp:DropDownList> <br/>
                                                   <asp:TextBox ID="txtFuelLinkage" runat="server" Visible="false" CssClass="form-control"  MaxLength="20" placeholder="Fuel Linkage"></asp:TextBox> <br />
                                               <span id="lb1122" class="form-label">Technology*</span>
                                                <asp:DropDownList ID="ddlTech" runat="server" AutoPostBack="true" CssClass="" DataValueField="tech" DataTextField="tech"    EnableViewState="true" > </asp:DropDownList> <br/>
                                             <span id="lb1125" class="form-label">Unit No*</span>
                                              <asp:TextBox ID="txtUnitNo" runat="server"  CssClass="form-control"  MaxLength="3" Width="100px" placeholder=""></asp:TextBox> <br />
                                                <span id="lb1126" class="form-label">Capacity of Unit in MW *</span>
                                              <asp:TextBox ID="txtCapacity" runat="server"  CssClass="form-control"  MaxLength="3" Width="100px" placeholder=""></asp:TextBox> <br />
                                                         &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;   <asp:Button ID="btnSignUp" runat="server" Visible="True" Text="Add Unit" style="background-image: -moz-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);   background-image: -webkit-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);    background-image: -ms-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);" CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10"  />  
                                                     <asp:Label ID="lbSure" runat="server" Text="All details are OK. Are you sure to Add above Unit??" Visible="false"></asp:Label> <br />      &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;   <asp:Button ID="btnSubmit" runat="server" Visible="false" Text="Yes" style="background-image: -moz-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);   background-image: -webkit-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);    background-image: -ms-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);" CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10"  />  
                                                  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;   <asp:Button ID="btnCancel" runat="server" Visible="false" Text="Cancel" style="background-image: -moz-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);   background-image: -webkit-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);    background-image: -ms-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);" CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10"  />  
                                                      
                                                          <br /> <br />
                                                          - Please ensure no duplication of Unit records   <br />
                                                           - CEA may approve/reject Unit details entered.  <br />
                                                          </asp:Panel>
