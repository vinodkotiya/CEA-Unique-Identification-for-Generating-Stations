<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vlogin.aspx.vb" Inherits="vlogin" %>
...
#demo
{
     display:block;
      position:absolute;
      color: #ffffff; font-family: 'Raleway',sans-serif; font-size: 20px; font-weight: 800; line-height: 36px; margin: 0 0 24px; text-align: center; 
}
    </style>
</head>
<body>
    ...
    <span id="head" runat="server"><%--<spam>E8 & Above Appraisal</spam> <br /> Access Denied - 403--%></span>
    <div id="divMsg" runat="server"></div>
   <%-- <small>---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</small>--%>
         <p class="copyright"><a href="http://10.0.236.168">©2017 Design & Developed by CC-IT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
  </div>
