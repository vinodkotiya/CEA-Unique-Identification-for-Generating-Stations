<%@ Page Language="VB" AutoEventWireup="false" CodeFile="gen.aspx.vb" Inherits="gen" EnableEventValidation="false" %>
...
<link href="bobtheme/css/bootstrap-slider.css" rel="stylesheet" />
  <%--  <link href="bobtheme/css/jquery-ui.css" rel="stylesheet" />--%>
  ...
  <div id="tabs">
    ...
    <%--  <li><a href="#"><span>Two</span></a></li>
      ...
      <li><a href="#"><span>Four</span></a></li>--%>
								...
								<p>Mandatory Information to be filled at the time of registration</p>   
...
<asp:Button ID="btnSave" runat="server" Text="Submit Details" style="background-image: -moz-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);   background-image: -webkit-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);    background-image: -ms-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);" CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10" />  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; 
  <asp:Label ID="lbConfirm" Visible="false" runat="server" Text="Are you sure to submit the details?"></asp:Label> <br />
 <asp:Button ID="btnSubmit" runat="server" Visible="false" Text="Confirm" style="background-image: -moz-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);   background-image: -webkit-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);    background-image: -ms-linear-gradient(0deg, #3e69fe 0%, #4cd4e3 100%);" CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10"  />  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; 
                                      <asp:Button ID="btnCancel" runat="server" Text="Cancel" Visible="false"  CssClass="primary-btn submit-btn d-inline-flex align-items-center mr-10"   />
                                            </div>      <%-- form body div--%>
                                              </div>      <%-- form area div--%>
                               </div>      <%-- feedback div--%>
							</div>
    ...
    <script src="bobtheme/js/vendor/jquery-2.2.4.min.js"></script>
      ...
      <script>
          $('#<%=btnSave.ClientID%>').click(function () {
              var result = window.confirm('Are you sure, you want to Submit the Information?');
              if (result == true)
                  return true;
              else
                  return false;
          });
        <%--  $('#<%=rbl12_5.ClientID%>').click(function(){
              alert('Y');
          });--%>
    
     function StandardConfirm(sender, args) {
                args.set_cancel(!window.confirm("Are you sure, you want to Submit the Information?"));
     }
        </script>

  <%--  <script src="bobtheme/js/jquery-ui.js"></script>
  <%--   <script>
  //$( function() {
  //    $('.vindateClass').datepicker({
  //    changeMonth: true,
  //    changeYear: true
  //    });
  //    $('.vindateClass').datepicker("option", "dateFormat", "dd.mm.yy");
  //    var date = new Date($('.vindateClass').val().replace(/(\d{2})-(\d{2})-(\d{4})/, "$2.$1.$3"));
  //    $('.vindateClass').datepicker('setDate', date);
