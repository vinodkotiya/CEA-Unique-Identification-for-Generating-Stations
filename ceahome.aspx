<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ceahome.aspx.vb" Inherits="ceahome" EnableEventValidation="false" %>
  ...
  CssClass="gvRow"   AlternatingRowStyle-CssClass="gvAltRow"  AutoGenerateColumns="false">  <Columns>    <asp:TemplateField>
      <HeaderTemplate>      
        ...
        <th>Project</th>
          ...
          <th>Capacity</th>
            ...
            <th>View Details</th>
                              <th>Project Correction</th>
                     <th>Unit Correction</th>
      ...
      <ItemTemplate>
          <td><%# Eval("project")%></td>
           ...
           <td><asp:Button ID="LinkButton1" runat="server" Text="Edit Proj" CommandArgument='<%# Eval("project_code")%>' CommandName="proj"  /></td>
           <td><asp:Button ID="LinkButton2" runat="server" Text="Edit Unit" CommandArgument='<%# Eval("projunit")%>' CommandName="unit"  /></td>
              <td><asp:Button ID="btnMyKPAEdit" runat="server" CommandName="approve"  Text='<%#IIf(projAction(Eval("project_code"), Eval("unit")), "Take Action", "View")%>' CommandArgument='<%# Eval("projunit")%>' /></td>
      </ItemTemplate>
    </asp:TemplateField>
